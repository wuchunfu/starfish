    ...
    public void batchCreateOrUpdate(RowData<T> rowData) throws AbstractMetaParserException {
        if (rowData.getEntities() != null) {
            for (EntityRow entity : rowData.getEntities()) {
                ...
                condition.setFilters(Arrays.asList(ConditionPiece.entityWithIdAndQualifiedName(entity.getHeader().getId(), entity.getHeader().getQualifiedName())));
        ...
        if (rowData.getRelations() != null) {
            for (RelationRow relation : rowData.getRelations()) {
                ...
                condition1.setFilters(Arrays.asList(ConditionPiece.entityWithIdAndQualifiedName(relation.getStartNode().getId()
                ...
                condition2.setFilters(Arrays.asList(ConditionPiece.entityWithIdAndQualifiedName(relation.getEndNode().getId(), relation.getEndNode().getQualifiedName())));
