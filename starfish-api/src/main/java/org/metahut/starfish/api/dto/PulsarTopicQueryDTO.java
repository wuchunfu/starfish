...
public class PulsarTopicQueryDTO extends PageRequestDTO {
    ...
    private Map<String, EachPointer> eachPointerMap() {
        ...
        map.put("publishers",new EachPointer(LinkCategory.RELATIONSHIP, RelationType.CHILD));
        map.put("schemas",new EachPointer(LinkCategory.RELATIONSHIP, RelationType.CHILD));
