...
public interface IngestionController {
    ...
    ResultEntity<IngestionCollectorResponseDTO> createCollector(@RequestBody IngestionCollectorRequestDTO ingestionCollectorRequestDTO);
    ...
    ResultEntity<IngestionCollectorResponseDTO> updateCollector(@PathVariable(value = "code", required = true) Long collectorId
            , @RequestBody IngestionCollectorRequestDTO ingestionCollectorRequestDTO);

    //delete
    @ApiOperation(value = "deleteCollector", notes = "DELETE_INGESTION_COLLECTOR_INSTANCE_NOTES")
    @DeleteMapping("/{code}")
    ResultEntity deleteCollector(@PathVariable(value = "code", required = true) Long collectorId);
