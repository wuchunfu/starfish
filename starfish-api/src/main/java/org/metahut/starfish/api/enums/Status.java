...
public enum Status {
    ...
    COLLECTOR_TASK_SCHEDULE_DOES_NOT_EXIST(20004, "COLLECTOR_TASK_SCHEDULE_DOES_NOT_EXIST"),
    COLLECTOR_TASK_DELETE_ADAPTER_EXIST(20005,"COLLECTOR_TASK_DELETE_ADAPTER_EXIST"),
